...
// source from : http://codeguru.earthweb.com/staticctrl/credit_static.shtml
...
#define NORMAL_CENTER         4   // '%'
#define LEFT_ALIGN1           5   // '$'
#define LEFT_ALIGN2           6   // '`'

#define MAX_STYLES         (LEFT_ALIGN2+1)        
...
protected:
	COLORREF    m_Colors[5];
	int         m_TextHeights[MAX_STYLES];
   TCHAR       m_Escapes[MAX_STYLES];
